...
def base_minimize(func, dimensions, base_estimator,
                  ...
                  xi=0.01, kappa=1.96, n_jobs=1, model_queue_size=None, init_samples=None, init_durations=None):
    ...
    for n in range(n_calls):
        ...
        if len(next_x) == 16:
            ...
            f.write("n_calls:" + str(n + 1) + "\n")
            print("n_calls:" + str(n + 1))
            print("X:" + str(next_x))
            next_y = func(next_x)
            durations.append(next_y)
            end_time = time.time()
            durations.append(next_y)
            f.write("X:" + str(next_x) + "\n")
            f.write("Y:" + str(next_y) + "\n")
            f.write("Y_min_now:" + str(min(durations)) + "\n")
            f.write("time_total_consume:" + str(end_time - start_time) + "\n\n")
            print("Y:" + str(next_y))
            print("Y_min_now:" + str(min(durations)))
            print("time_total_consume:" + str(end_time - start_time))
