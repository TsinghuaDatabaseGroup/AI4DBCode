...
public class InstacartSpeedComparison {


  public static void main(String[] args) throws IOException {
    Pair<Vector<Assertion>, Vector<Assertion>> assertionPair = 
        AssertionReader.readAssertion("Instacart/assertion_instacart.txt", "Instacart/permanent_assertion_instacart.txt");
    ...
    System.out.println("stHoles test");
    stHolesTest(permanent_assertions, assertions, queryAssertion);
    System.out.println("");
  }
  ...
  private static void stHolesTest(
      Vector<Assertion> permanent_assertions,
      Vector<Assertion> assertions,
      List<Assertion> queryset) {
    List<Integer> list = Arrays.asList(10,
