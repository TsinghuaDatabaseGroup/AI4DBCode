        ...
        for line in lines:
            ...
            for table in tables:
                try:
                    ...
                    ########## TODO BEGIN ##########
                    if table not in table2conditions:
                        sample_bitmap.append([1] * data_samples.shape[0])
                    else:
                        ########### TODO END ###########
...
def get_col_statistics(cols, data_dir):
    alias2table = {'t1': 'auth_user', 't2': 'student_courseenrollment', 't3': 'organization_account_userorgprofile',
                   't4': 'auth_userprofile'}
    names = []
    cards = []
    distinct_nums = []
...
def select_samples(data_dir):
    table2alias = {'auth_user': 't1', 'student_courseenrollment': 't2', 'organization_account_userorgprofile': 't3',
                   'auth_userprofile': 't4'}
    samples = {}
