...
def load_and_encode_train_data(num_queries, num_materialized_samples, train_queries, min_max_file):
    file_name_queries = train_queries
    file_name_column_min_max_vals = min_max_file
...
def get_train_datasets(num_queries, num_materialized_samples, train_query_file, min_max_file):
    dicts, column_min_max_vals, min_val, max_val, labels_train, labels_test, max_num_joins, max_num_predicates, train_data, test_data = load_and_encode_train_data(
        num_queries, num_materialized_samples, train_query_file, min_max_file)
