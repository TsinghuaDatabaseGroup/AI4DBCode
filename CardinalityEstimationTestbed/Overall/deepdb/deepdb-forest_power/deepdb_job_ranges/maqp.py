...
if __name__ == '__main__':
    ...
    # fmetric = open('/home/zhangjintao/Benchmark3/metric_result/' + args.version + '.deepdb.txt', 'a')
    ...
    if args.generate_ensemble:
        ...
        if args.ensemble_strategy == 'single':
            ...
            candidate_evaluation(version, schema, args.hdf_path, args.samples_rdc_ensemble_tests, args.samples_per_spn,
