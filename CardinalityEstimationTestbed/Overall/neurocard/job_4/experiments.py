...
TEST_CONFIGS['job-light-ranges-reload'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges'],
    **{
        'checkpoint_to_load': 'models/imdb-4.2MB-model62.674-made-resmade-hidden128_128_128_128-emb16-directIo-embedInembedOut-embsTied-dropout-learnableUnk-factorized-groupedDropout-14wsb-10epochs-10.24Mtups-seed0.pt',
        'eval_psamples': [512, 8000],
