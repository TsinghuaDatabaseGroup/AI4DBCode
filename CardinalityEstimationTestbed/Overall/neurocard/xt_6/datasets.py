...
class JoinOrderBenchmark(object):
    ALIAS_TO_TABLE_NAME = {
        ...
        't3': 'organization_account_userorgprofile'
    }
    ...
    RANGE_COLUMNS = collections.defaultdict(
        list,
        {
            ...
            'organization_account_userorgprofile': ['org_id', 'role']
            # 1095
    ...
    BASE_TABLE_PRED_COLS = collections.defaultdict(
        list,
        {
            ...
            'organization_account_userorgprofile': ['id', 'org_id', 'user_id', 'role']
            # 1095
    ...
    def GetJobLightJoinKeys():
        return {
            ...
            'organization_account_userorgprofile': 'user_id'
