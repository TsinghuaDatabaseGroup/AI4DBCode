python train_model.py --csvname forest.csv --num-gpus=1 --dataset=forest --epochs=80 --warmups=8000 --bs=2048 --residual --layers=5 --fc-hiddens=256 --direct-io --column-masking
