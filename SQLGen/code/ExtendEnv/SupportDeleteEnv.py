...
class GenDeleteEnv(object):
    ...
    def get_sql(self):
        ...
        self.sql = "delete from {} {}".format(self.from_clause, self.where_clause)
        return self.sql

    def from_observe(self, observation=None):
        # print("enter from observation")
    ...
    def observe(self, observation):
        ...
        """
        if observation == self.c_obj.word_num_map['delete']:
    ...
    def step(self, action):
        ...
        elif action == self.c_obj.word_num_map['delete']:
